...
<body>
    <div style='display:block; background-color:#2194E0; color:white; font-size:1.5rem;'>안녕하세요. <?php $n=$_SESSION['name']; $c=$_SESSION['code']; echo "$n($c)";?>님!</div>
    ...
    <form name="uploadForm" id="uploadForm" method="post" action="/upload.php" enctype="multipart/form-data" onsubmit="return formSubmit(this);">
        ...
        <div style="display:inline-flex; flex-direction:column; width:80%; height:auto; margin:0rem 10% 0rem;">
            ...
            <div style="font-size: 8px;">
                * 사진의 해상도가 클 경우 회전되어 보일 수 있으나 서버에는 원래 방향대로 업로드됩니다.
            </div>
            <br />
            <input type="submit" id="m" name="m" value="업로드" style="flex:1 1 0; padding:2rem; margin-bottom:2rem;" />
        </div>
    </form>
</body>
</html>